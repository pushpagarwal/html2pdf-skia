...
describe("tokenizer", () => {
  describe("<ident>", () => {
    it("auto", () =>
      deepEqual(tokenize("auto"), [
        { type: TokenType.IDENT_TOKEN, value: "auto" },
      ]));
    it("url", () =>
      deepEqual(tokenize("url"), [
        { type: TokenType.IDENT_TOKEN, value: "url" },
      ]));
    it("auto test", () =>
  ...
  describe("<url-token>", () => {
    it("url(test.jpg)", () =>
      deepEqual(tokenize("url(test.jpg)"), [
        { type: TokenType.URL_TOKEN, value: "test.jpg" },
      ]));
    it('url("test.jpg")', () =>
      deepEqual(tokenize('url("test.jpg")'), [
        { type: TokenType.URL_TOKEN, value: "test.jpg" },

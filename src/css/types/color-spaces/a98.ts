 ...
 * @param a98
 */
export const a98Linear2xyz = (
  a98: [number, number, number]
): [number, number, number] => {
  return multiplyMatrices(
    // eslint-disable-next-line prettier/prettier
    [

 ...
 * @param p3
 */
export const proPhotoLinearToXyz = (
 ...
 * @param xyz
 */
export const xyzToProPhotoLinear = (
 ...
 * @param p3
 */
export const proPhotoToProPhotoLinear = (
  p3: [number, number, number]
): number[] => {
 ...
 * @param p3
 */
export const proPhotoLinearToProPhoto = (
  p3: [number, number, number]
): number[] => {
  return p3.map((c: number) => {
 ...
 * @param args
 */
export const proPhotoFromXYZ = (
  args: [number, number, number, number]
): [number, number, number, number] => {
  const [r, g, b] = proPhotoLinearToProPhoto(

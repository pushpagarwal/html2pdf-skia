 ...
 * @param rgb
 */
export const rec20202rec2020Linear = (
 ...
 * @param rgb
 */
export const rec2020Linear2rec2020 = (
  rgb: [number, number, number]
): number[] => {
  return rgb.map(function (c) {
 ...
 * @param rec
 */
export const rec2020LinearToXyz = (
 ...
 * @param xyz
 */
export const xyzToRec2020Linear = (
 ...
 * @param args
 */
export const rec2020FromXYZ = (
  args: [number, number, number, number]
): [number, number, number, number] => {
  const [r, g, b] = rec2020Linear2rec2020(

...
const parse = (context: Context, value: string) =>
  image.parse(context, Parser.parseValue(value));
const colorParse = (context: Context, value: string) =>
  color.parse(context, Parser.parseValue(value));
  ...
  describe("<image>", () => {
    describe("parsing", () => {
      describe("url", () => {
        ...
        it('url("test.jpg")', () =>
          deepStrictEqual(
            parse(context, 'url("http://example.com/test.jpg")'),
            {
              url: "http://example.com/test.jpg",
              type: CSSImageType.URL,
            }
      ...
      describe("linear-gradient", () => {
        ...
        it("linear-gradient(to bottom, yellow, blue)", () =>
          deepStrictEqual(
            parse(context, "linear-gradient(to bottom, yellow, blue)"),
            {
              angle: deg(180),
              type: CSSImageType.LINEAR_GRADIENT,
              stops: [
        ...
        it("linear-gradient(180deg, yellow, blue)", () =>
          deepStrictEqual(
            parse(context, "linear-gradient(180deg, yellow, blue)"),
            {
              angle: deg(180),
              type: CSSImageType.LINEAR_GRADIENT,
              stops: [
        ...
        it("linear-gradient(to top, blue, yellow)", () =>
          deepStrictEqual(
            parse(context, "linear-gradient(to top, blue, yellow)"),
            {
              angle: 0,
              type: CSSImageType.LINEAR_GRADIENT,
              stops: [
        ...
        it("linear-gradient(to top right, blue, yellow)", () =>
          deepStrictEqual(
            parse(context, "linear-gradient(to top right, blue, yellow)"),
            {
              angle: [
        ...
        it("linear-gradient(to bottom, yellow 0%, blue 100%)", () =>
          deepStrictEqual(
            parse(context, "linear-gradient(to bottom, yellow 0%, blue 100%)"),
            {
              angle: deg(180),
              type: CSSImageType.LINEAR_GRADIENT,
              stops: [

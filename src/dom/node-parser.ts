...
export const isLIElement = (node: Element): node is HTMLLIElement =>
  node.tagName === "LI";
export const isOLElement = (node: Element): node is HTMLOListElement =>
  node.tagName === "OL";
export const isInputElement = (node: Element): node is HTMLInputElement =>
  node.tagName === "INPUT";
export const isHTMLElement = (node: Element): node is HTMLHtmlElement =>
  node.tagName === "HTML";
export const isSVGElement = (node: Element): node is SVGSVGElement =>
  node.tagName === "svg";
export const isBodyElement = (node: Element): node is HTMLBodyElement =>
  node.tagName === "BODY";
